...
- **PR bodies:** never pass the body inline in the shell (PowerShell mangles escapes/quotes). Write the body to a temp file and pass it with `gh pr create/edit --body-file <path>`.
